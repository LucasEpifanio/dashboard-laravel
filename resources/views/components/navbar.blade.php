<div class="top-bar">
    ...
    <div class="top-bar1">
        <div class="icons-navbar">
          ...
          <div class="paste-button-notification">
                <button class="button-notification" onclick="toggleDropdownNotifi()"><img class="search1-1-icon" alt="" src="./storage/assets/icons/notification-bing.5 1.svg" /></button>
                <div class="dropdown-notification" id="dropdownContentNotification">
                </div>
            </div>
        </div>
